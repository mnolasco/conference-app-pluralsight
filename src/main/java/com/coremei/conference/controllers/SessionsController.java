...
public class SessionsController {
	...
	public Session get(@PathVariable Long id) {
		return sessionRepository.findById(id).orElseGet(null);
	}
	...
	public Session update(@PathVariable Long id, @RequestBody final Session session) {
		Session foundSession = sessionRepository.findById(id).orElseGet(null);
		System.out.println(foundSession);
		BeanUtils.copyProperties(session, foundSession, "id");
